...
bool sentiment_init(UDF_INIT* initid, UDF_ARGS* args, char* message) {
    ...
    if (analyzer == nullptr) {
        try {
            ...
            std::string model_path = "/Users/eashanbajaj/Documents/Purdue/CS541/CS541Project/albert_model/albert_sentiment_model.pt";
            std::string tokenizer_model_path = "/Users/eashanbajaj/Documents/Purdue/CS541/CS541Project/albert_tokenizer/spiece.model";
