...
/* CS541 - Testing for logging in server */
#include "sql/log.h"
...
%token                TESTPRED_SYM 1222                 /* CS541 addition */
...
expr:
        ...
        /* CS541 */
        | TESTPRED_SYM
          /* CS541 addition. Works independently as a predicate so doesn't need bit_expr.
             This will probably work fine for the isolated testing case, but can't evaluate w/
             other expressions like this. At least this is my hypothesis.
          */
          {
            sql_print_information("test_pred found!");
            $$ = new Item_int(1);
          }
